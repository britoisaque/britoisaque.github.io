          ...
          <div class="footer-social">
            <a href="#" data-instagram-link target="_blank" rel="noopener" aria-label="Instagram" hidden>
              <svg viewBox="0 0 24 24">
                ...
                <circle cx="12" cy="12" r="12" fill="url(#igGradFooter)"/>
            ...
            <a href="#" data-facebook-link target="_blank" rel="noopener" aria-label="Facebook" hidden>
              <svg viewBox="0 0 24 24">
                ...
                <svg x="7.6" y="5" width="8.75" height="14" viewBox="0 0 320 512"><path fill="#fff" d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"/></svg>
              </svg>
            </a>
          </div>
        </div>
